...
//  HabitifyReport
//  This file was bootstrapped from JSON Schema using quicktype.
//
...
struct Habit: Codable, Equatable {
    ...
    let goal: Goal
    let goalHistoryItems: [Goal]
    let logMethod, recurrence: String
    let remind: [JSONAny]
    let area: Area
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case goal
        case goalHistoryItems = "goal_history_items"
        case logMethod = "log_method"
        case recurrence, remind, area
...
struct Goal: Codable {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case value, periodicity
    }
}

struct HabitLogsJson: Codable {
    let message: String
    let logs: [HabitLog]?
    let version: String
    let status: Bool
